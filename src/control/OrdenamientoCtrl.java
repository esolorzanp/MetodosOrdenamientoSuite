...
public class OrdenamientoCtrl {
    private List<String> exprStringList;
    private List<Integer> exprIntegerList;
    private List<String> ordeStringList;
    private List<Integer> ordeIntegerList;

    public OrdenamientoCtrl() {
        initLists();
    }
